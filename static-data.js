...
(function () {
  ...
  window.CS4_STATIC_DATA = {
  "courses": [
    {
      "name": "Operating System",
      "slug": "operating-system",
      "table": "questions_operating_system",
      "category": "Core CS",
      "enabled": true
    },
    {
    ...
    },
    {
      ...
      "table": "questions_data_structures",
      "category": "Core CS",
      "enabled": true
    },
    {
      ...
      "table": "questions_computer_networks",
      "category": "Core CS",
      "enabled": true
    },
    {
      ...
      "table": "questions_computer_organization",
      "category": "Core CS",
      "enabled": true
    },
    {
      ...
      "table": "questions_theory_of_computation",
      "category": "Core CS",
      "enabled": true
    },
    {
      ...
      "table": "questions_discrete_mathematics",
      "category": "Core CS",
      "enabled": true
    },
    {
      ...
      "table": "questions_digital_electronics",
      "category": "Core CS",
      "enabled": true
    },
    {
      ...
      "table": "questions_compiler_design",
      "category": "Core CS",
      "enabled": true
    },
    {
      ...
      "table": "questions_engineering_mathematics",
    ...
    },
    {
      ...
      "table": "questions_general_aptitude",
      "category": "Aptitude",
      "enabled": true
    },
    {
      "name": "Programming & Data Structures in C",
      "slug": "c-programming",
      "table": "questions_programming_data_structures_c",
  ...
  "users": [
    ...
    {
      "id": 2,
      "name": "Free Demo Student",
      "email": "free@cs4gate.demo",
      "password": "free123",
      "role": "student",
      "plan": "free",
      "target_year": "2027",
      "email_verified_at": "2026-01-02 00:00:00",
      "created_at": "2026-01-02 00:00:00"
    },
    {
      "id": 3,
      "name": "Paid Demo Student",
      "email": "paid@cs4gate.demo",
      "password": "paid123",
      "role": "student",
      "plan": "paid",
      "target_year": "2027",
      "email_verified_at": "2026-01-03 00:00:00",
  ...
  "designSettings": {
    "global": {
      ...
      "fontHeading": "\"Sora\", \"Inter\", \"Segoe UI\", system-ui, -apple-system, sans-serif",
      "cardRadiusPx": 8,
      "cardShadow": "rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px",
      "cardShadowHover": "rgba(0, 0, 0, 0.24) 0px 3px 8px",
      "thumbDashboardHeight": 102,
      "thumbCourseQuestionHeight": 112,
      "thumbSubjectHeight": 124,
      "thumbChapterHeight": 132,
      "thumbBrandText": "CS4GATE",
      "groupPresetPublic": "royal",
      "groupPresetFree": "ocean",
      "groupPresetPaid": "emerald"
    },
    "light": {
      "primary": "#1FA5AD",
      "accent": "#5B2F99",
      ...
      "textMuted": "#5F6D7A",
      "border": "#B9C8D8",
      "buttonPrimaryBg": "#5B2F99",
      "buttonPrimaryText": "#FFFFFF",
      "thumbBaseStart": "#15283F",
      "thumbBaseMid": "#19314E",
      "thumbBaseEnd": "#1B2E49",
      "thumbGlow": "#7150D9",
      "thumbCorner": "#2AB3C6",
      "thumbLabel": "#D7BCFF",
      "thumbTitle": "#FFFFFF",
      "thumbSubtitle": "#DCE8FF",
      "thumbBrand": "#C9DCFF",
      "thumbBorder": "#5B2F99",
      "shortcutBaseStart": "#15283F",
      "shortcutBaseMid": "#19314E",
      "shortcutBaseEnd": "#1B2E49",
      "shortcutGlow": "#7150D9",
      "shortcutCorner": "#2AB3C6",
      "shortcutLabel": "#D7BCFF",
      "shortcutTitle": "#FFFFFF",
      "shortcutSubtitle": "#DCE8FF",
      "shortcutBrand": "#C9DCFF",
      "shortcutBorder": "#5B2F99"
    },
    "dark": {
      "primary": "#4ED1DC",
      "accent": "#9D69FF",
      ...
      "textMuted": "#B1BFD0",
      "border": "#44566B",
      "buttonPrimaryBg": "#9D69FF",
      "buttonPrimaryText": "#FFFFFF",
      "thumbBaseStart": "#0F2034",
      "thumbBaseMid": "#173355",
      "thumbBaseEnd": "#152947",
      "thumbGlow": "#9F74FF",
      "thumbCorner": "#2BBFD0",
      "thumbLabel": "#CFB4FF",
      "thumbTitle": "#F4F7FF",
      "thumbSubtitle": "#D2DEF6",
      "thumbBrand": "#CDD8EF",
      "thumbBorder": "#8F63DE",
      "shortcutBaseStart": "#D0D7E3",
      "shortcutBaseMid": "#C6CEDA",
      "shortcutBaseEnd": "#BCC5D2",
      "shortcutGlow": "#9F74FF",
      "shortcutCorner": "#58CAD8",
      "shortcutLabel": "#4F347F",
      "shortcutTitle": "#17253A",
      "shortcutSubtitle": "#283C55",
      "shortcutBrand": "#263D5A",
      "shortcutBorder": "#8D79B8"
    }
  }
};
